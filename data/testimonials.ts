...
export const testimonials: Testimonial[] = [
  {
    ...
    location: 'Udaipur',
    rating: 5,
    text: "Words genuinely fail me. When I first saw our wedding gallery, I sat down on the floor and cried for twenty minutes. Not because I was sad — because I was overwhelmed that someone had captured things I didn't even know happened. The moment my dad looked at me before walking me down the aisle. The way Arjun's hands were shaking. Photopitaraa didn't photograph our wedding. They told our story.",
    eventType: 'Wedding',
    date: 'February 2025',
    platform: 'Google',
  ...
  },
  {
    ...
    location: 'Delhi',
    rating: 5,
    text: "I hired Photopitaraa for my mother's 70th birthday and they treated it with the same reverence as a royal wedding. The photos are absolutely gorgeous — every detail, every tear, every spontaneous group hug. My mother carries a print of one photograph in her purse everywhere she goes.",
    eventType: 'Birthday',
    date: 'September 2024',
    platform: 'Google',
  ...
  },
  {
    ...
    location: 'Jaipur',
    rating: 5,
    text: "We gave them a massive venue, 600 guests, and a 4-day celebration. They handled it all with a calm professionalism that was deeply reassuring. But what truly sets Photopitaraa apart is the editing — each image has a mood, a light quality, that makes our wedding look like it happened in a film. Which, in a way, it did.",
    eventType: 'Wedding',
    date: 'March 2025',
    platform: 'Google',
